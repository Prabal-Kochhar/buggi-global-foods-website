...
import './WhyChooseUs.css'; // Import component-specific CSS

function WhyChooseUs() {
  return (
    <section id="why-choose-us" className="why-choose-us-section py-16">
          ...
          <div className="card why-choose-us-card">
            ...
            <ul className="solution-list">
              <li>
                ...
                <span className="font-semibold accent-text"> Mama's Chilli Powder</span>, is registered and rapidly
