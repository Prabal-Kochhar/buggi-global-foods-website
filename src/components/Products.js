...
function Products() {
  return (
    <section id="products" className="products-section section-padding"> {/* Added id="products" and global padding */}
      <div className="container">
        <h2 className="section-heading">Our Products</h2>

        <div className="grid gap-12 grid-cols-1 md:grid-cols-2"> {/* Using global grid classes */}
          ...
          <div className="card">
            ...
            <p className="card-text mb-6">
              Our pride and joy, <span className="font-semibold text-accent">Mama's Chilli Powder</span>, is a fast-moving
